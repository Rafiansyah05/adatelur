...
import { Egg, Banknote, ShieldCheck, Truck, ArrowRight, Image as ImageIcon } from 'lucide-react';
      ...
      <div className="mx-auto grid max-w-[1160px] items-center gap-10 px-5 md:grid-cols-2 md:gap-14 md:px-6">
        <div>
          ...
          <p className="mt-4 max-w-[480px] text-[16px] leading-relaxed text-landing-desc md:text-[17px]">
            Belanja telur langsung dari sumbernya. Lebih segar, harga lebih jujur, dan kamu tahu persis dari
            mana telurmu berasal.
          </p>
          ...
          <Link
            ...
            className="mt-9 inline-flex items-center justify-center gap-2 rounded-md bg-landing-400 px-6 py-4 text-[15px] font-bold text-landing-950 transition-all hover:-translate-y-0.5 hover:bg-landing-500 active:scale-[.98]"
          >
            Belanja Sekarang
