        ...
        <div className="w-full md:w-72 flex flex-col gap-6 shrink-0 md:border-r md:border-neutral-100 md:p-6 md:bg-neutral-50/30">
          ...
          <Card className="flex flex-col bg-white border border-neutral-100 shadow-sm rounded-xl overflow-hidden p-2 gap-1 hidden md:flex md:border-none md:shadow-none md:bg-transparent md:p-0">
            <button
              ...
              className={`flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-semibold transition-colors ${activeTab === 'data_diri' ? 'bg-primary-50 text-primary-900' : 'text-neutral-600 hover:bg-neutral-50'
                }`}
            >
            ...
            <button
              ...
              className={`flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-semibold transition-colors ${activeTab === 'lokasi' ? 'bg-primary-50 text-primary-900' : 'text-neutral-600 hover:bg-neutral-50'
                }`}
            >
            ...
            <button
              ...
              className={`flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-semibold transition-colors ${activeTab === 'password' ? 'bg-primary-50 text-primary-900' : 'text-neutral-600 hover:bg-neutral-50'
                }`}
            >
          ...
          <div className="md:hidden flex overflow-x-auto hide-scrollbar gap-2 px-1">
            <button
              onClick={() => setActiveTab('data_diri')}
              className={`flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm font-semibold transition-colors shrink-0 ${activeTab === 'data_diri' ? 'bg-primary-50 text-primary-900' : 'bg-white border border-neutral-200 text-neutral-600'
                }`}
            >
            ...
            <button
              onClick={() => setActiveTab('lokasi')}
              className={`flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm font-semibold transition-colors shrink-0 ${activeTab === 'lokasi' ? 'bg-primary-50 text-primary-900' : 'bg-white border border-neutral-200 text-neutral-600'
                }`}
            >
            ...
            <button
              onClick={() => setActiveTab('password')}
              className={`flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm font-semibold transition-colors shrink-0 ${activeTab === 'password' ? 'bg-primary-50 text-primary-900' : 'bg-white border border-neutral-200 text-neutral-600'
                }`}
            >
