...
export default function Home() {
  ...
  // Fetch Peternak Terbaik on mount (default params)
  useEffect(() => {
  ...
  return (
    <div className="w-full flex flex-col gap-16 md:gap-24 pb-20">
      {/* HERO SECTION */}
      <section className="relative w-screen ml-[calc(-50vw+50%)] overflow-hidden bg-primary-950 md:min-h-[450px] flex items-center">
        {/* Banner Background */}
        ...
        <div className="relative z-10 w-full max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 p-6 md:p-8 items-center">
          ...
          <div className="hidden lg:flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              <h1 className="text-3xl font-semibold text-white tracking-tight">adatelur.</h1>
              <h2 className="text-4xl font-semibold text-white leading-tight mt-2">
                Telur Segar,<br />Langsung dari Peternak.
              </h2>
              <p className="text-primary-100 text-base max-w-md mt-1 leading-relaxed">
      ...
      <section className="w-full flex flex-col gap-6">
        <div className="flex items-center justify-between px-2">
          <div className="flex flex-col gap-1">
            <h2 className="text-3xl font-black text-neutral-900 tracking-tight">Peternak Terbaik</h2>
            <p className="text-neutral-500 font-medium">Berdasarkan skor dan kualitas sistem kami.</p>
          </div>
          <Link href="/search" className="hidden md:inline-flex text-primary-600 font-bold hover:text-primary-700 transition-colors">
            Lihat semua
          </Link>
        </div>

        <div className="w-full overflow-x-auto pb-8 -mx-6 px-6 md:mx-0 md:px-0 hide-scrollbar">
          {isLoadingTop ? (
