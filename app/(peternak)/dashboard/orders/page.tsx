              ...
              {!photoPreview ? (
                <div className="flex flex-col items-center gap-3">
                  <button
                    ...
                    className={`h-16 w-16 rounded-full border-4 flex items-center justify-center shadow-lg transition-transform ${locationStatus === 'granted'
      ...
      <div className="sticky top-16 md:top-[76px] z-30 mb-6 -mx-4 px-4 md:mx-0 md:px-0 flex gap-1 overflow-x-auto border-b border-border bg-white pt-2 pb-1 shadow-sm md:shadow-none">
        {[
          ...
          <button
            ...
            className={`shrink-0 border-b-2 px-4 py-2.5 text-sm font-semibold transition-colors ${activeTab === tab.key
                    ...
                    <div className="flex items-start gap-4 flex-1">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                          <span className={`inline-flex items-center gap-1 text-xs font-semibold px-2 py-1 rounded border ${order.fulfillment_method === 'pickup'
                  ...
                  <div className="flex flex-1 items-start gap-4">
                    ...
                    <div className="flex-1">
                      <div className="flex flex-wrap items-center gap-3 mb-2">
                        ...
                        <span className={`px-2.5 py-1 rounded-md text-xs font-bold ${order.payment_status === 'paid' ? 'bg-success-bg text-success-text border border-success' : 'bg-primary-100 text-primary-700 border border-primary-200'
                          }`}>
                      ...
                      <div className="flex items-start gap-4 flex-1">
                        ...
                        <div className="flex-1">
                          <div className="flex flex-wrap items-center gap-2 mb-1">
                            ...
                            <span className={`px-2 py-0.5 rounded text-xs font-bold ${order.order_status === 'completed' ? 'bg-success-bg text-success-text border border-success' :
